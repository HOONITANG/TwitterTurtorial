...
class LoginController: UIViewController {
    ...
    // preferredStatusBarStyle을 사용하여 BarStyle을 변경할수있음
    ...
    @objc func handleLogin() {
        ...
        AuthService.shared.logUserIn(withEmail: email, password: password) { (result, error) in
            if let error = error {
                print("DEBUG:: Erorr logging in \(error.localizedDescription)")
                return
            }
    ...
    func configureUI() {
        ...
        dontHavaAccountButton.anchor(left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingLeft: 40, paddingRight: 40)
